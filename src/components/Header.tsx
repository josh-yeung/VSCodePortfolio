...
function Header() {
  return (
    <div id="Header" className="mx-12 lg:mx-60 pt-16 items-center justify-center lg:w-1/2 text-justify">
      ...
      <div className="flex flex-row mt-8 space-x-6 w-2/3">
        <button className="flex-1 border border-lightblue_vs text-lightblue_vs p-3 rounded hover:bg-opacity-10 hover:bg-lightblue_vs shadow-[0_10px_30px_-15px_rgba(96,165,250,0.6)]">
